<?php
    ...
    $id = $_GET['id'];
    $method = $_GET["method"];
    $sql_updatequery = "select * from article where articleid = '$id'";
    $rs = mysqli_query($link, $sql_updatequery);
    while ($record = mysqli_fetch_row($rs))
    {
        $articleid = $record[0];
        $articlename = $record[1];
        $articletype = $record[2];
        $articlecontent = $record[3];
    }
?>
            ...
            <tr>
                <td>
                    <table style="width: 600px; border: 1px solid black;">
                        <tr>
                            <th colspan="2" align="center">文章基本資料</th>
                        </tr>
                        <tr>
                            <th align="center">篇名:</th>
                            <td><input type="text" name="articlename" value="<?php echo $articlename ?>"required></td>
                        </tr>
                        <tr align="center">
                            <th>類別:</th>
                            <td>
                                <input type="checkbox" name="articletype[]" value="管理與政策">管理與政策
                                <input type="checkbox" name="articletype[]" value="國際企業">國際企業
                                <input type="checkbox" name="articletype[]" value="行銷管理">行銷管理
                                <input type="checkbox" name="articletype[]" value="國際貿易">國際貿易
                                <input type="checkbox" name="articletype[]" value="生產與作業管理">生產與作業管理
                                <input type="checkbox" name="articletype[]" value="統計">統計<br>
                                <input type="checkbox" name="articletype[]" value="人力資源管理">人力資源管理
                                <input type="checkbox" name="articletype[]" value="數量方法">數量方法
                                <input type="checkbox" name="articletype[]" value="資訊管理">資訊管理
                                <input type="checkbox" name="articletype[]" value="會計">會計
                                <input type="checkbox" name="articletype[]" value="財務管理">財務管理
                                <input type="checkbox" name="articletype[]" value="審計">審計
                            </td>
                        </tr>
                        <tr>
                            <th align="center">摘要:</th>
                            <td>
                                <textarea name="articlecontent" style="height: 115px; width: 100%; resize: vertical;" onkeyup="autogrow2(this)" required><?php echo $articlecontent ?></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr align="center">
                <td align="center">
                    <table style="width: 600px; border: 1px solid black;" align="center">
                        <tr>
                            <th align="center"><input type="submit" value="修改"></th>
                        </tr>
                    </table>
                </td>
            </tr>
