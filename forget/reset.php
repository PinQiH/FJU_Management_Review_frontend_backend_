    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="./login/loginindex.php">使用者登入</a></li>
        </ul>
      </nav><!-- .nav-menu -->
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="./login/loginindex.php">登入</a></li>
...
<div class="containerr">
  <form method="post" action="updatepassword.php" onsubmit="return validateForm()">
      <input type=hidden name="email" value="<?php echo $_POST["email"] ?>">
      <div class="containerrr">
      <table align="center">
          <tr>
            <td><label for="password"><b>密碼</b></label></td>
            <td colspan="2" align="left"><input type="password" placeholder="Enter Password" name="password" id="password" required></td>
        </tr>
        <tr>
            <td><label for="password_check"><b>再次輸入密碼&nbsp;</b></label></td>
            <td colspan="2" align="left"><input type="password" placeholder="Repeat Password" name="password_check" id="password_check" required></td>
        </tr>
          <tr>
            <td colspan="3"><input type="submit" value="修改密碼" name="submit"></td>
        </tr>
          </table>
      </div>
  </form>
