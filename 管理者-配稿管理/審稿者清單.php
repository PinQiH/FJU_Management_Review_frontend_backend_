  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        ...
        <table id="myDataTalbe" class="review" style="text-align:center">
        <thead>

            <tr>
                <th style="width: 10%">編號</th>
                <th style="width: 30%">審稿者名稱</th>
                <th style="width: 60%">專業領域</th>
            </tr>
        </thead>
        <tbody>
            <?php
                    ...
                    $sql = "select * from user where auth = '審稿者'";
                    $result = mysqli_query($link, $sql);
                
                    while ($record = mysqli_fetch_row($result))
                    {
                        echo "<tr><td>$record[0]</td><td>$record[1]</td><td>$record[3]</td></tr>";
                    }
                    mysqli_close($link);
