...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $conreplyname=$_POST["conreplyname"]; 
    

    $replytype=$_POST["conreplytype"];
    $conreplytype=implode (',', $replytype);
    
    $conreplycontent=$_POST["conreplycontent"];
    /*
    $_FILES["articlepath"]
    ...
    */
        ...
        $sql="INSERT INTO `$articlename` (conreplyname, conreplytype, conreplycontent) VALUES('".$conreplyname."','".$conreplytype."','".$conreplycontent."')";
