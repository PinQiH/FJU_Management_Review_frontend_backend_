    ...
    <!-- ======= Portfolio Details Section ======= -->
        ...
        <div>
            <?php
                    ...
                    //<li><b>發布時間：</b>109 年 09 月 29 日</li><br>
                    while ($record = mysqli_fetch_row($result))
                    {
                        echo "<ul>
                                <li><h2><b>$record[1]</b></h2></li><br>
                                
                                <li><b>作者：</b>$record[4]</li><br>
                                <li><b>摘要</b></li><br>
                                <li>$record[3]</li><br>
                                <input class='btn' type='button' name='download' id='download' value='下載全文' onclick='location.href='''/>
                                <br><br>
                              </ul>";
                    }
                    mysqli_close($link);
