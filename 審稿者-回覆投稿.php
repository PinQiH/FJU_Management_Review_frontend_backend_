  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="審稿者-線上審稿.php">審稿清單</a></li>
            <li>回覆文章</li>
          </ol>
        </div>
    ...
    <section class="about">
      <div class="container">
        ...
        <div align="center">
        <form method="post" action="addreply.php" enctype="multipart/form-data">
        <?php
            ...
            <tr>
                <td>
                    <table style="width: 600px; border: 1px solid black;">
                        <tr>
                            <th colspan="2" align="center">回覆文章</th>
                        </tr>
                        <tr>
                            <th>審稿決定:</th>
                            <td align="left">
                              <select name="replydecision">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="replycontent" style="height: 115px; width: 100%; resize: vertical;" onkeyup="autogrow2(this)" required></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr align="center">
                <td align="center">
                    <table style="width: 600px; border: 1px solid black;" align="center">
                        <tr>
                            <th align="center"><input type="hidden" value=""><input type="submit" value="回覆"></th>
                        </tr>
                    </table>
                </td>
            </tr>
