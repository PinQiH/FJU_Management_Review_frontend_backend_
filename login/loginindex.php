    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="./loginindex.php">使用者登入</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
              <p class="card-title text-center"><font face="微軟正黑體">請輸入有效帳號，感謝您的合作。</font><br><br></p>
            <form class="form-signin" action="./login.php" method="post">
              <div class="form-label-group">
                <input type="email" name="email" 
                 id="inputEmail" value="<?php echo $COOKIE["email"]?>" class="form-control" placeholder="Email address" width="100%" required autofocus>
                <label for="inputEmail"></label>
              </div>

              <div class="form-label-group">
                <input type="password" name="password" value="<?php echo $COOKIE["password"]?>" id="inputPassword" class="form-control" placeholder="Password" width="100%" required>
                <label for="inputPassword"></label>
              </div>

              <div class="custom-control custom-checkbox mb-3">
                <input type="checkbox" name="remember" <?php echo empty($_COOKIE["user"])?"":"checked='checked'" ?> class="custom-control-input" id="customCheck1">
                <label class="custom-control-label" for="customCheck1" align="left">自動登入</label>
              </div>
              <input type="submit" value="登入" name="submit"><br><br>
              
              <table width= "100%">
              <tr>
                <td><h6 align="left"><a href="../forget/forget.php">忘記密碼</a></h6></td>
                <td><h6 align="right"><a href="../register.html">註冊帳號</a></h6></td>
              </tr>
              </table>
            </form>
          </div>
