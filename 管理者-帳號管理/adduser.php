...
<body>
  ...
  <main id="main">
    ...
    <section class="about">
      <div class="container">
<form method="post" action="register2.php" onsubmit="return validateForm()">
  <div class="containerrr">
    <table align="center">
        <tr>
            <td><label for="username"><b>姓名</b></label></td>
            <td colspan="2" align="left"><input type="text" placeholder="Enter Username" name="username" id="username" required></td>
        </tr>
        <tr>
            ...
            <td colspan="2" align="left">
                ...
                <input type="radio" name="auth" id="auth" value="審稿者">審稿者
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2" align="left"><input type="email" placeholder="Enter Email" name="email" id="email" required></td>
        </tr>
        <tr>
            <td><label for="phone"><b>電話</b></label></td>
            <td colspan="2" align="left"><input type="tel" placeholder="Enter phone" name="phone" id="phone" required></td>
        </tr>
        <tr>
            <td><label for="password"><b>密碼</b></label></td>
            <td colspan="2" align="left"><input type="password" placeholder="Enter Password (length>6)" name="password" id="password" required></td>
        </tr>
        <tr>
            <td colspan="3"><input type="submit" value="新增" name="submit"></td>
        </tr>
    </table>
  </div>
</form>
